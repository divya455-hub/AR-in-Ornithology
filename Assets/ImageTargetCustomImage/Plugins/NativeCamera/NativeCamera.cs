...
public static class NativeCamera
{
    ...
    public static void TakePicture(CameraCallback cameraCallback, object callback, int v, object p1, PreferredCamera preferredCamera, object p2)
    {
        throw new NotImplementedException();
    }

    public static Texture2D TakePicture()
    {
        throw new NotImplementedException();
    }
    ...
    public static Permission TakePicture(Action<string> p, string v1, string v2)
    {
        throw new NotImplementedException();
    }
